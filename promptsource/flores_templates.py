...
IN_PROMPT = """{{{{sentence_{}}}}} Give me the same text in {}. |||{{{{sentence_{}}}}}"""
AB_PROMPT = """A text in {}: {{{{sentence_{}}}}}\nWhat's the text in {}? |||{{{{sentence_{}}}}}"""
...
def add_langs(l1):
    ...
    for (l2_name, l2_code) in langs:
        ...
        subset_name = f"{l1_code}-{l2_code}"
        #if os.path.exists(f"/Users/muennighoff/Desktop/promptsource/promptsource/templates/facebook/flores/{subset_name}.jsonl"):
        #    print(f"Skipping {subset_name} as it already exists.")
        #    continue
